                        ...
                        <div onClick={() => {
                            ...
                            {hasMultipleHeroes ? (
                                ...
                                <OptimizedImage
                                    ...
                                    preset={upgradePreset(getSessionPreset())}
                                    skipDowngrade={true}
                                    className={`w-full h-full object-cover ${heroHasRealImage
                            ...
                            {hasMultipleHeroes && (
                                <div className="absolute bottom-[calc(2rem+env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 z-30 flex gap-2">
                                    {heroProjects.map((_, idx) => (
                                        <button
                                            ...
                                            className={`w-2 h-2 rounded-full transition-all duration-300 ${idx === currentHeroIndex
                                                ? 'bg-white w-6'
            ...
            <div className={`${THEME.filmography.paddingTop} ${THEME.filmography.paddingBottom} ${THEME.header.paddingX} bg-bg-main relative z-10`}>
                <div className="max-w-7xl mx-auto">
                    ...
                    {config.portfolioId === 'postproduction' ? (
                        ...
                        /* Ultra Minimal CTA - Dark Theme */
                        <div className="relative py-16 md:py-24 border-t border-white/10 -mx-4 md:-mx-8 lg:-mx-12">
                            <div className="flex flex-col items-center justify-center text-center px-6">
                                <h2 className="text-xl md:text-3xl font-serif italic text-white/90 mb-8 font-light">
                                    Let's create something beautiful.
                                </h2>
                                <button
                                    onClick={() => navigate('/about')}
                                    className={`group inline-flex items-center gap-3 px-8 py-3 rounded-full border border-white/20 hover:border-white/60 hover:bg-white hover:text-black transition-all duration-500`}
                                >
                                    <span className={`${THEME.typography.meta}`}>Get in Touch</span>
